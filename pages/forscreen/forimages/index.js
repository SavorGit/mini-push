...
Page({
  ...
  chooseLaunchType:function(e){
    ...
    if(launchType=='speed'){
      ...
      mta.Event.stat('clickChangeLinkType',{'openid':openid,'linktype':2,'forscreentype':2})
    }else {
      self.setData({launchType:launchType});
      app.globalData.change_link_type = 1;
      mta.Event.stat('clickChangeLinkType',{'openid':openid,'linktype':1,'forscreentype':2})
    }
